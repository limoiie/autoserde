...
import autodict
from autodict import AutoDict, UnableFromDict, UnableToDict, dictable, \
...
class Serdeable:
    ...
    def serialize(self, fp: Optional[IO[str] or PathLike or str] = None,
    ...
    @classmethod
    def deserialize(cls, fp: IO[str] or PathLike or str or bytes,
...
class AutoSerde:
    ...
    @staticmethod
    def serialize(obj: Any, fp: Optional[IO[str] or PathLike or str] = None,
                  fmt: Optional[str] = None, with_cls: bool = True,
                  close_fp: bool = False):
        """
        Dump obj into target in the specific serialization format.
        ...
        elif isinstance(fp, (PathLike, str)):
    ...
    @staticmethod
    def deserialize(fp: IO[str] or PathLike or str,
                    cls: Type[T] = None, fmt: Optional[str] = None,
                    close_fp: bool = False) -> T:
        """
        Load obj in the specific deserialization format.
        ...
        try:
            formatter = SerdeFormat.instance_by(fmt)
            obj = AutoDict.from_dict(formatter.load(fp), cls=cls)
            return obj
